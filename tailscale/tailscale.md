...
Tailscale is a free, zero-config mesh VPN service which is built on the WireGuard protocal. It allows for secure peer-to-peer connection that is accessible to users of various technical
...
apple and google acounts), and configuring one of my devices (my Dell laptop running Pihole) as a subnet router.

There are a variety of other features offered by Tailscale which I have yet to use, such as Aperture to manage AI models.
